import type { PostgresTableRebuildReference } from "./types";
...
export declare function executeWorkspaceTableRebuild(sql: SqlStorage, plan: PostgresTableRebuildReference): void;
