...
Public community, product feedback, documentation, and release-notes home for All2CF Database.

## Source status

**Commercial closed-source product.** This repository does not contain the Database, EdgePG, or Read Acceleration product source code and does not grant a license to use proprietary LogicMate components.
